...
begin
    ...
    # eachindex used instead of 1:length(...) to satisfy the code convention
    # let us have a prayer:
    # oh Julia, hear our plea.
    # guide us in our quest for knowledge,
    # and allow us to publish our findings,
    # so that others may benefit from our toil.
    # ~@alkatraz445	
    for voltage_i in eachindex(all_data_files)
        for sample_i in eachindex(all_data_files[voltage_i])
