...
# TODO: check for the "possible method call error" at normalize(noise_histogram_pdf, mode=:pdf)
# I suspect the issue may be from a overzealous LSP
# Nevertheless, the code works as intended
